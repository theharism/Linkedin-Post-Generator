      ...
      <div className={style.mainDiv}>
        <div className={style.introDiv}>
          <p className={style.intro}>
            Affiliate Program{" "}
            <span className={style.earn}>
              {" "}
              EARN 20% COMISSION ON ALL PAYMENTS{" "}
            </span>
          </p>
          <h1>
            Boost 💰💸 Your <span> Earnings </span>
          </h1>
          <p className={style.para}>
            By joining our program, you have the opportunity to earn a 20%
            commission on all payments from customers you refer to MUSE. Get
            your
            <span
              className={style.earn}
        ...
        <div className={style.introDiv}>
          <h4 style={{ marginBottom: 20 }}>
            Calculate Your <span style={{ color: "#1e86e2" }}> Earnings </span>
          </h4>
